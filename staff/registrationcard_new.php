<?php // $Id: registrationcard.php,v 1.2 2011/06/20 07:22:00 shtifanov Exp $
    ...
    $numericfield = array('yeargraduate', 'pedagog', 'standing', 'standing_this', 'standing', 'totalstanding');
...
function update_appointment($usernew)
{
   global $CFG, $USER, $edutype, $oid, $rid, $uid;
    ...
    for ($num=1; $num<9; $num++)    {
        ...
        $profile = new stdClass();
        $profile->fields = array('appointmentid', 'staffid', 'stafftypeid', 'meetingid', 'appointment', 'prevappointment', 'date_start_app', 'qualify', 'qualify_date', 'place_advan_train', 'qualifynow'); // , 'stafftypeid', 'meetingid');
        $profile->type   = array('real', 'real', 'real', 'real', 'text', 'text', 'date', 'text', 'date', 'text', 'text'); // , 'stft', 'meet');
