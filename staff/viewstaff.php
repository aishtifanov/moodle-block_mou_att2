<?php // $Id: viewstaff.php,v 1.3 2011/08/03 06:58:14 shtifanov Exp $
    ...
    if ($view_capability)	{
        ...
        $appointments = get_records_select ('monit_att_appointment', "staffid={$teacher->id}", 'id DESC', 'id, staffid, stafftypeid, meetingid, appointment, pedagog_time, standing, standing_this, qualify, qualify_date, qualifynow, place_advan_train, date_advan_train, total_mark');
        if ($appointments)  {
