...
{   
 ...
 Рекомендовать ГАК установить <u> $user->dativecase $user->strcateg квалификационную категорию </u>  по должности «<u>$truncateappointment</u>», т.к. уровень профессиональной компетентности педагога соответствует требованиям, предъявляемым к <u>$user->strcateg2  квалификационной категории</u>, и подтверждается показателями, исчисляемыми в баллах.<br>
<p><b >Примечание:</b>
